...
public class Reminder {
	...
	public String toString() {
		return new StringBuilder().append("Reminder [reminderId=").append(this.reminderId).append(", reminderName=")
				.append(this.reminderName).append(", reminderDescription=").append(this.reminderDescription)
				.append(", reminderType=").append(this.reminderType).append(", reminderCreatedBy=")
				.append(this.reminderCreatedBy).append(", reminderCreationDate=").append(this.reminderCreationDate)
				.append("]").toString();
	}
