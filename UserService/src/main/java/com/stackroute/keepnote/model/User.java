...
public class User {
	...
	public String toString() {
		return new StringBuilder().append("User [userId=").append(userId).append(", userName=").append(userName)
				.append(", userPassword=").append(userPassword).append(", userMobile=").append(userMobile)
				.append(", userAddedDate=").append(userAddedDate).append("]").toString();
	}
